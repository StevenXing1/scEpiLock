...
class PreProcessor():
    ...
    def concate_data(self):
        pos_fasta = pd.read_csv(self.pos_fasta_path,sep=">chr*",header=None, engine='python').values[1::2][:,0] #new data file # (n,) array, each element is string, dtype=object
